...
create or replace function public.public_booking_insert_services_v6(
...
grant execute on function public.public_booking_insert_services_v6(text,uuid,text,text,jsonb) to anon,authenticated,service_role;

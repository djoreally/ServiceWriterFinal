-- Provider identity is a routing identifier used by checkout/rewards/dispatch, not an authorization secret.
...
revoke all on function public.public_booking_insert_services_v6(text,uuid,text,text,jsonb) from public,anon,authenticated;

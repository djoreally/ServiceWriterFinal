...
revoke all on function public.update_workspace_scheduling_settings_v1(uuid,jsonb,integer,integer,integer,integer,boolean,integer,boolean,boolean,integer,text,boolean) from public;

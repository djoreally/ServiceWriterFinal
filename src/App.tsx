...
const Dashboard = lazyRetry(() => import("./legacy-pages/Dashboard"));
const CRM = lazyRetry(() => import("./legacy-pages/CRM"));
const AccountImport = lazyRetry(() => import("./legacy-pages/AccountImport"));
const Customers = lazyRetry(() => import("./legacy-pages/Customers"));
const CustomerDetail = lazyRetry(() => import("./legacy-pages/CustomerDetail"));
const Vehicles = lazyRetry(() => import("./legacy-pages/Vehicles"));
const VehicleDetail = lazyRetry(() => import("./legacy-pages/VehicleDetail"));
const Services = lazyRetry(() => import("./legacy-pages/Services"));
const ServiceDetail = lazyRetry(() => import("./legacy-pages/ServiceDetail"));
...
const Quotes = lazyRetry(() => import("./legacy-pages/Quotes"));
const Appointments = lazyRetry(() => import("./legacy-pages/Appointments"));
const AppointmentDetail = lazyRetry(() => import("./legacy-pages/AppointmentDetail"));
const PublicBooking = lazyRetry(() => import("./legacy-pages/PublicBooking"));
const TenantBooking = lazyRetry(() => import("./legacy-pages/TenantBooking"));
...
const Payments = lazyRetry(() => import("./legacy-pages/Payments"));

const Marketing = lazyRetry(() => import("./legacy-pages/Marketing"));
const MarketingVideos = lazyRetry(() => import("./legacy-pages/MarketingVideos"));
const Newsletter = lazyRetry(() => import("./legacy-pages/Newsletter"));
const FeaturesGuide = lazyRetry(() => import("./legacy-pages/FeaturesGuide"));
const FeatureDetail = lazyRetry(() => import("./legacy-pages/FeatureDetail"));
const VehicleSpecs = lazyRetry(() => import("./legacy-pages/VehicleSpecs"));
const TestimonialSubmit = lazyRetry(() => import("./legacy-pages/TestimonialSubmit"));
const PaymentSuccess = lazyRetry(() => import("./legacy-pages/PaymentSuccess"));
const CustomerMessagingPreferences = lazyRetry(() => import("./legacy-pages/CustomerMessagingPreferences"));
...
const CustomerAuth = lazyRetry(() => import("./legacy-pages/CustomerAuth"));
const CustomerDashboard = lazyRetry(() => import("./legacy-pages/CustomerDashboard"));
const FleetManagerPortal = lazyRetry(() => import("./legacy-pages/FleetManagerPortal"));
...
const Invoices = lazyRetry(() => import("./legacy-pages/Invoices"));
...
const InvitationCenter = lazyRetry(() => import("./legacy-pages/InvitationCenter"));
...
const SessionManagement = lazyRetry(() => import("./legacy-pages/SessionManagement"));
const Fleet = lazyRetry(() => import("./legacy-pages/Fleet"));
const VanDetail = lazyRetry(() => import("./legacy-pages/VanDetail"));
const TechnicianOS = lazyRetry(() => import("./legacy-pages/TechnicianOS"));
const DispatchEngine = lazyRetry(() => import("./legacy-pages/DispatchEngine"));
const WeatherGuard = lazyRetry(() => import("./legacy-pages/WeatherGuard"));
const CommandCenter = lazyRetry(() => import("./legacy-pages/CommandCenter"));
const Messages = lazyRetry(() => import("./legacy-pages/Messages"));
const Receptionist = lazyRetry(() => import("./legacy-pages/Receptionist"));
const RetentionEngine = lazyRetry(() => import("./legacy-pages/RetentionEngine"));
const RetentionVerify = lazyRetry(() => import("./legacy-pages/RetentionVerify"));
const VoiceAgentEmbed = lazyRetry(() => import("./legacy-pages/VoiceAgentEmbed"));
const FleetSchedulingPage = lazyRetry(() => import("./legacy-pages/fleet-os/FleetSchedulingPage"));

// Tech App (Field Technician Mobile App)
const TechAppLayout = lazyRetry(() => import("./legacy-pages/tech-app/TechAppLayout"));
const TechToday = lazyRetry(() => import("./legacy-pages/tech-app/TechToday"));
const TechJobs = lazyRetry(() => import("./legacy-pages/tech-app/TechJobs"));
const TechFleet = lazyRetry(() => import("./legacy-pages/tech-app/TechFleet"));
const TechJobDetail = lazyRetry(() => import("./legacy-pages/tech-app/TechJobDetail"));
const TechDataCenter = lazyRetry(() => import("./legacy-pages/tech-app/TechDataCenter"));
const TechRoute = lazyRetry(() => import("./legacy-pages/tech-app/TechRoute"));
const TechNavigation = lazyRetry(() => import("./legacy-pages/tech-app/TechNavigation"));
const TechMessages = lazyRetry(() => import("./legacy-pages/tech-app/TechMessages"));
const TechMore = lazyRetry(() => import("./legacy-pages/tech-app/TechMore"));
const TechInventory = lazyRetry(() => import("./legacy-pages/tech-app/TechInventory"));
const TechShift = lazyRetry(() => import("./legacy-pages/tech-app/TechShift"));
const TechShiftReview = lazyRetry(() => import("./legacy-pages/tech-app/TechShiftReview"));
const TechProfile = lazyRetry(() => import("./legacy-pages/tech-app/TechProfile"));
const TechSettings = lazyRetry(() => import("./legacy-pages/tech-app/TechSettings"));
const TechServices = lazyRetry(() => import("./legacy-pages/tech-app/TechServices"));
const Assets = lazyRetry(() => import("./legacy-pages/Assets"));
const FieldCompanion = lazyRetry(() => import("./legacy-pages/FieldCompanion"));

...
function DrawerTrigger(props: React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Trigger>): React.JSX.Element {
...
function DrawerOverlay({
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Overlay>): React.JSX.Element {
...
function DrawerContent({
  ...
  children,
  ...props
}: React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content>): React.JSX.Element {
  return (
    <DrawerPortal>
      <DrawerOverlay />
      <DrawerPrimitive.Content
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[calc(100dvh-1rem)] flex-col overflow-y-auto rounded-t-xl border bg-background pb-[env(safe-area-inset-bottom)]",
          className,
        )}
        {...props}
      >
...
function DrawerTitle({
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Title>): React.JSX.Element {
  return (
...
function DrawerDescription({
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Description>): React.JSX.Element {

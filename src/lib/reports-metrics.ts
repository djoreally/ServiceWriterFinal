export type ReportDateBasis = "service_date" | "scheduled_date" | "paid_at" | "created_at";
...
export const REPORT_METRICS: ReportMetricDefinition[] = [
  { key: "net_collected", label: "Net collected", source: "payments", dateBasis: "paid_at", formula: "Successful collections minus refunds" },
  ...
  { key: "refunds", label: "Refunds", source: "payments", dateBasis: "paid_at", formula: "Refunded payment amount" },
  { key: "tax_collected", label: "Tax collected", source: "payments", dateBasis: "paid_at", formula: "Settled-payment tax metadata", caveat: "Metadata fallback is monitored in Data Quality." },
